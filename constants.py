TOKENS_ERROR_TEXT = 'Недоступна одна или несколько переменных окружения'
...
KEY_HOMEWORKS_ERROR_TEXT = 'Отсутствует ключ "homeworks"'

INDEX_ERROR_TEXT = 'В списке нет работ c обновленным статусом'

KEY_ERROR_TEXT_STATUS = 'Отсутствует ключ "status"'
